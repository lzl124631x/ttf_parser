...
namespace ttf_dll{
  ...
  public:
    ...
    USHORT  length;
    USHORT  language;
    Encoding_Table(std::ifstream &fin);
  ...
  public:
    ...
    void load_encoding_table(std::ifstream &fin, std::streampos base);
    ~Encoding_Record(){
      DEL(encoding_table);
    }
  };
...
/******************************* encoding tables ***********************************/
  ...
  public:
    ...
    Byte_Encoding_Table(std::ifstream &fin);
    ~Byte_Encoding_Table(){}
  ...
  public:
    ...
    High_Byte_Mapping_Through_Table(std::ifstream &fin);
  ...
  public:
    ...
    Segment_Mapping_To_Delta_Values(std::ifstream &fin);
  ...
  public:
    ...
    Trimmed_Table_Mapping(std::ifstream &fin);
